...
class MainNav extends React__default.Component {
  ...
  render() {
    console.log(this.state);
    let logoGroupStyle = this.state.width > 500 ? {
      marginLeft: 90
    } : {
      marginLeft: 10
    };
    let rightGroupStyle = this.state.width > 500 ? {
      marginRight: 90
    } : {
      marginRight: 10,
      display: "none"
    };
    let searchStyle = this.state.width > 500 ? {
      marginLeft: 50
    } : {
      marginLeft: 50,
      display: "none"
    ...
    }, /*#__PURE__*/React__default.createElement("div", null, /*#__PURE__*/React__default.createElement(ShoppingCart, {
      height: 20
    }), /*#__PURE__*/React__default.createElement(Search, {
      height: 20
    })), /*#__PURE__*/React__default.createElement(ExternalLink, {
      height: 20
    }), /*#__PURE__*/React__default.createElement(XCircle, {
      height: 20
    })), /*#__PURE__*/React__default.createElement(Navbar.Group, {
      align: Alignment.RIGHT,
